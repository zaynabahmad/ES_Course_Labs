...
# 9 "../ES_Course_Labs/APP/main.c" 2

# 1 "../ES_Course_Labs/APP/../HAL/LED/LED_interface.h" 1



# 1 "../ES_Course_Labs/APP/../HAL/LED/../../SERVICES/STD_TYPES.h" 1
...
# 5 "../ES_Course_Labs/APP/../HAL/LED/LED_interface.h" 2
...
# 11 "../ES_Course_Labs/APP/main.c" 2
# 1 "../ES_Course_Labs/APP/../HAL/Switch/Switch_interface.h" 1
# 11 "../ES_Course_Labs/APP/../HAL/Switch/Switch_interface.h"
void Switch_Init(u8 Port, u8 Pin);
u8 switch_read(u8 Port, u8 Pin);
# 12 "../ES_Course_Labs/APP/main.c" 2
# 1 "../ES_Course_Labs/APP/../MCAL/GPIO/GPIO_interface.h" 1
# 31 "../ES_Course_Labs/APP/../MCAL/GPIO/GPIO_interface.h"
void GPIO_SetPinDirection(u8 Port, u8 Pin, u8 Direction);
void GPIO_SetPinValue(u8 Port, u8 Pin, u8 Value);
u8 GPIO_GetPinValue(u8 Port, u8 Pin);
void GPIO_Init(void);
# 13 "../ES_Course_Labs/APP/main.c" 2
...
void main()
{
    ...
    while(1)
    {
                if ((switch_read(0, 0) == 0) && (switch_read(0, 1) == 0)) {
                        LED_Off(1, 0);
                        LED_Off(1, 1);
                }
                else if (switch_read(0, 0) == 1)
                {
                        LED_On(1, 0);
                        LED_On(1, 1);
