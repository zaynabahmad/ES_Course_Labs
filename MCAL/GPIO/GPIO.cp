#line 1 "C:/Users/HP/Desktop/Drivers/MCAL/GPIO/GPIO.c"
#line 1 "c:/users/hp/desktop/drivers/mcal/gpio/gpio_interface.h"
#line 1 "c:/users/hp/desktop/drivers/mcal/gpio/../../services/std_types.h"
...
#line 31 "c:/users/hp/desktop/drivers/mcal/gpio/gpio_interface.h"
void GPIO_SetPinDirection(u8 Port, u8 Pin, u8 Direction);
void GPIO_SetPinValue(u8 Port, u8 Pin, u8 Value);
u8 GPIO_GetPinValue(u8 Port, u8 Pin);
void GPIO_Init(void);
#line 1 "c:/users/hp/desktop/drivers/mcal/gpio/gpio_private.h"
#line 1 "c:/users/hp/desktop/drivers/mcal/gpio/gpio_config.h"
#line 1 "c:/users/hp/desktop/drivers/mcal/gpio/../../services/bit_math.h"
#line 6 "C:/Users/HP/Desktop/Drivers/MCAL/GPIO/GPIO.c"
void GPIO_SetPinDirection(u8 Port, u8 Pin, u8 Direction)
{
 switch(Port)
 {
...
u8 GPIO_GetPinValue(u8 Port, u8 Pin)
{
 ...
 switch(Port)
 {
 case  0 : Local_Value =  ( (( (*((volatile u8*)0x05)) ) >> (Pin)) & 1U ) ; break;
 case  1 : Local_Value =  ( (( (*((volatile u8*)0x06)) ) >> (Pin)) & 1U ) ; break;
 case  2 : Local_Value =  ( (( (*((volatile u8*)0x07)) ) >> (Pin)) & 1U ) ; break;
 case  3 : Local_Value =  ( (( (*((volatile u8*)0x08)) ) >> (Pin)) & 1U ) ; break;
 case  4 : Local_Value =  ( (( (*((volatile u8*)0x09)) ) >> (Pin)) & 1U ) ; break;
 default: break;
 }
 return Local_Value;
}
