...
;GPIO.c,8 :: 		void GPIO_SetPinDirection(unsigned char Port, unsigned char Pin, unsigned char Direction)
...
;GPIO.c,53 :: 		void GPIO_SetPinValue(unsigned char Port, unsigned char Pin, unsigned char Value)
...
;GPIO.c,98 :: 		unsigned char GPIO_GetPinValue(unsigned char Port, unsigned char Pin)
;GPIO.c,100 :: 		unsigned char Local_Value = 0;
