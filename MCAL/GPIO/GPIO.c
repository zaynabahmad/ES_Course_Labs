...
/* NEW: Toggle Pin Value Implementation */
...
/* --- NEW: Port-Level Implementations --- */
...
u8 GPIO_GetPortValue(u8 Port)
{
    ...
    switch(Port)
    {
        case GPIO_PORTA: Local_Value = PORTA; break;
        case GPIO_PORTB: Local_Value = PORTB; break;
        case GPIO_PORTC: Local_Value = PORTC; break;
        case GPIO_PORTD: Local_Value = PORTD; break;
        case GPIO_PORTE: Local_Value = PORTE; break;
        default: break;
    }
    return Local_Value;
}