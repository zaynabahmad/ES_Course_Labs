...
;GPIO.c,130 :: 		void GPIO_Init(void)
;GPIO.c,132 :: 		ADCON1 = 0x06;        // All digital
	MOVLW      6
	MOVWF      ADCON1+0
;GPIO.c,134 :: 		TRISA = GPIO_PORTA_DIR;
	CLRF       133
;GPIO.c,135 :: 		TRISB = GPIO_PORTB_DIR;
	MOVLW      255
	MOVWF      134
;GPIO.c,136 :: 		TRISC = GPIO_PORTC_DIR;
	CLRF       135
;GPIO.c,137 :: 		TRISD = GPIO_PORTD_DIR;
	CLRF       136
;GPIO.c,138 :: 		TRISE = GPIO_PORTE_DIR;
	CLRF       137
;GPIO.c,140 :: 		PORTA = GPIO_PORTA_INIT_VAL;
	CLRF       5
;GPIO.c,141 :: 		PORTB = GPIO_PORTB_INIT_VAL;
	CLRF       6
;GPIO.c,142 :: 		PORTC = GPIO_PORTC_INIT_VAL;
	CLRF       7
;GPIO.c,143 :: 		PORTD = GPIO_PORTD_INIT_VAL;
	CLRF       8
;GPIO.c,144 :: 		PORTE = GPIO_PORTE_INIT_VAL;
	CLRF       9
;GPIO.c,146 :: 		OPTION_REG.F7 = 0;    // Enable PORTB pull-ups
	BCF        OPTION_REG+0, 7
;GPIO.c,147 :: 		}
L_end_GPIO_Init:
	RETURN
